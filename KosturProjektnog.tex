...
%\documentclass[12pt, croatian]{article}Definisanje klase dokumenta i jezika -- hrvatski jezik
\usepackage[T1,T2A]{fontenc}
\usepackage[utf8]{inputenc}
\usepackage[serbian]{babel}
\usepackage{cmsrb} % Za srpsku ćirilicu
...
\AtBeginDocument{\renewcommand{\tocbibname}{ЛИТЕРАТУРА}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% UKOLIKO SE KORISTI LATINICA ONDA OBRISATI ILI KOMENTIRATI OVAJ DEO %
%%%%%%%%%%%%%%%%%%% SAMO ZA UPOTREBU ĆIRILICE %%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{titlepage}
	...
	\line(1,0){500}\\
	[0.5cm]
	\huge{\bfseries Prenos toplote}\\ % Naziv projekta i sl.
	[2mm]
	\line(1,0){500}\\
	\textsc{\large{Пројектни задатак}}\\% Naziv predmeta i sl.
	[1.5cm]	
	 \vspace*{2\baselineskip}
    \begin{center} % Centriranje slike, teksta...
\resizebox{0.3\textwidth}{!}{ 
\includegraphics{{logo_mf.pdf}} % Logo fakulteta ili slično
% ne mora biti .pdf formata
}
\end{center}
    {\Large Mašinski fakultet Univerziteta u Beogradu} \\ {\large Катедра за ...} \\ % Ime ustanove i katedre
...
\newpage
\renewcommand{\thepage}{} % Komanda za uklanjanje numeracije stranice
